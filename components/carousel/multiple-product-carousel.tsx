              ...
              products.map((product, index) => (
                ...
                >
                  <div className="relative flex flex-col px-4 py-5 sm:p-6 border rounded-lg">
                    {isCompareProduct ? (
                      <div
                        className="absolute flex justify-end w-full ml-[-50px]  "
                        onClick={() => {
                          handleRemove(product.id, index);
                        }}
                      >
                  ...
                  {isCompareProduct && (
                    <>
                      <div className="w-full ">
                        <p className="sticky z-[10000] text-xl my-4 font-bold mr-2">
                          Key Features
                        </p>
                      </div>
                      <div className="text-xl my-5 border-r">
                        {product?.keyFeatures?.map((feature, index) => (
                          <li className="text-sm md:text-base p-2 " key={index}>
